<?php
        ...
        !empty($_POST["surname"]) && !empty($_POST["confirm_password"]) && !empty($_POST["allow"]))
    {
        ...
        # USERNAME
        // Controlla che l'username rispetti le regole date
        ...
        if (count($error) == 0) {
            ...
            if (mysqli_query($conn, $query)) {
                ...
                $_SESSION["username_id"] = mysqli_insert_id($conn); //importante, mi permette di dire che l'id dell'utente loggato è quello della sessione
                mysqli_close($conn);
                header("Location: home.php");
                exit;
            } else {
